...
def get_dns(dns_list=["8.8.8.8", "1.1.1.1"]):
...
def get_routing():
    routing = RoutingBean(domainStrategy=DomainStrategy.IpIfNonMatch)
    return routing


def generateConfig(config: str, dns_list=["8.8.8.8", "1.1.1.1"]):
    allowInsecure = True
    ...
    if protocol == EConfigType.VMESS.protocolName:
        ...
        fingerprint = vmessQRCode.fp if vmessQRCode.fp else streamSetting.tlsSettings.fingerprint if streamSetting.tlsSettings else "firefox"
        ...
        v2rayConfig = V2rayConfig(
            ...
            log=get_log(),
            inbounds=[get_inbound(), get_inbound2()],
...
if __name__ == "__main__":
    ...
    share_link = input("Enter The Share Link:\n")
    print("\n\n\n")
    print(generateConfig(share_link))
